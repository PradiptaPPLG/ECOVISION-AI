      ...
      <div className="space-y-3">
        {isLowConfidence && (
          <p className="text-sm font-medium text-amber-800 dark:text-amber-200">
            Warning: The AI confidence is below 80%. Please verify this classification manually before sorting.
          </p>
        )}
        
        <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
          <strong className="text-zinc-700 dark:text-zinc-300">AI Note: </strong>
          {confidenceNote}
        </p>

        <p className="text-sm leading-relaxed text-zinc-500 dark:text-zinc-500">
          EcoVision AI uses advanced vision models for educational purposes. AI classifications may occasionally be incorrect due to lighting, angles, or obscured materials.
        </p>
      </div>
    </div>
  );
