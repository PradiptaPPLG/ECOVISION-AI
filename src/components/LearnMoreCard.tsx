  ...
  return (
    <div className="rounded-2xl bg-white p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] ring-1 ring-zinc-200/50 dark:bg-zinc-950 dark:ring-zinc-800/50">
      ...
      <div className="space-y-4">
        <div>
          <h4 className="mb-1 text-sm font-semibold text-zinc-900 dark:text-zinc-100">About this material</h4>
        ...
        <div className="border-t border-zinc-100 pt-4 dark:border-zinc-800/50">
          <h4 className="mb-1 text-sm font-semibold text-zinc-900 dark:text-zinc-100">Why recycle it?</h4>
          <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
            {environmentalImpact}
          </p>
        </div>
